...
namespace Slides
{
    public class CameraController : MonoBehaviour
    {
        ...
        public static event Action<Vector3, Quaternion> OnCameraFinishTransition;
        ...
        public void ReleaseCameraReference()
        {
            ...
            if (cameraMoving != null)
            {
                ...
                OnCameraFinishTransition?.Invoke(mainCamera.transform.position, mainCamera.transform.rotation);
            }
        ...
        private void OnGUI()
        {
            ...
            if (!canZoom || mainCamera == null || cameraMoving != null) return;
        ...
        private void Update()
        {
            if (mainCamera == null || (!canRotateX && !canRotateY) || cameraMoving != null) return;
        ...
        public void InitializeCamera()
        {
            ...
            if (mainCamera.transform.position != targetPosition || mainCamera.transform.rotation.eulerAngles != targetRotation || mainCamera.fieldOfView != fieldOfView)
            {
                cameraMoving = StartCoroutine(MoveToPosition(mainCamera.transform.position, targetPosition, mainCamera.transform.rotation,
        ...
        private IEnumerator MoveToPosition(Vector3 startPosition, Vector3 targetPosition, Quaternion startRotation,
            Vector3 targetRotation, float startFOV, float targetFOV, float slideTime)
        {
            float time = 0;
            ...
            while (time < slideTime)
            {
                ...
                mainCamera.transform.rotation = Quaternion.Slerp(startRotation, Quaternion.Euler(targetRotation), rotationCurve.Evaluate(time / slideTime));
